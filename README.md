...
Create a Mendix test project in the dist folder and rename its root folder to `dist/MxTestProject`. Or get the test project from https://github.com/mendixlabs/progress-bar/releases/download/1.0.1/TestProgressBar.mpk. Changes to the widget code shall be automatically pushed to this test project.
